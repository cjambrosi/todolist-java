package br.com.cjambrosi.todolist.filter;
...
import br.com.cjambrosi.todolist.user.IUserRespository;
import jakarta.servlet.FilterChain;
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;

// Sempre que quiser que o Spring gerencie uma classe, utilizar @Component
@Component
        ...
        if (serveletPath.startsWith("/tasks/")) {
          ...
          if (user == null) {
            ...
            if (passwordVerify.verified) {
              ...
              // Passa o request e response adiante para quem precisar (Controller)
